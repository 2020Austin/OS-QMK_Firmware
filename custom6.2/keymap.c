...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_all(
        ...
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,    CAPSWRD,  KC_DEL,   KC_HOME,  KC_PGUP,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,   KC_BSLS,  KC_DEL,   KC_END,   KC_PGDN,
        KC_BSPC,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT,
        KC_LSPO,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSPC,            KC_UP,
        KC_LCPO,  KC_LCMD,  KC_LALT,                                KC_SPC,                                 KC_RALT,  MO(WIN_FN), MO(WIN_ONE), KC_RCPC,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [WIN_FN] = LAYOUT_all(
        KC_TRNS,  KC_BRID,  KC_BRIU,  KC_TASK,  KC_FLXP,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,   RGB_VAD,  RGB_TOG,  RGB_VAI,  KC_TRNS,  KC_TRNS,  KC_TRNS,
        KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
    ...
    [WIN_ONE] = LAYOUT_all(
        KC_TRNS,  KC_ASTG,       KC_ASDN,           KC_ASUP,           KC_ASRP,       KC_TRNS,           KC_TRNS,           KC_TRNS,    KC_TRNS,  KC_TRNS,             KC_TRNS,     KC_TRNS, KC_TRNS, KC_LEFT, KC_TRNS, KC_RIGHT,   KC_TRNS, KC_TRNS, UC_MOD,
        KC_TRNS,  KC_TRNS,       KC_TRNS,           KC_TRNS,           KC_TRNS,       KC_TRNS,           KC_TRNS,           KC_TRNS,    KC_TRNS,  KC_TRNS,             KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS,  KC_TRNS,       KC_TRNS,           KC_TRNS,           KC_TRNS,       KC_TRNS,           KC_TRNS,           KC_TRNS,    KC_TRNS,  KC_TRNS,             KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS,  KC_TRNS,       KC_TRNS,           KC_TRNS,           KC_TRNS,       KC_TRNS,           KC_TRNS,           KC_TRNS,    KC_TRNS,  KC_TRNS,             KC_TRNS,     KC_TRNS,          KC_TRNS,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [WIN_ONE] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) }
};
#endif
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
		...
		// AutoShift toggle
		case KC_TOGG:
			if (record->event.pressed && autoshift) {
				//autoshift_disable();
				register_code16(KC_ASOFF);
				autoshift = false;
            } 
			else if (record->event.pressed && !autoshift) {
				//autoshift_enable();
				register_code16(KC_ASON);
				autoshift = true;
			}
                ...
                // Do something else when release
				if (autoshift) {
					unregister_code16(KC_ASON);
				}
				else {
					unregister_code16(KC_ASOFF);
				}
